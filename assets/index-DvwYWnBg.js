(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[],t=null,n=`jp-to-meaning`,r={"jp-to-meaning":[],"meaning-to-jp":[],"reading-to-jp":[]},i={"jp-to-meaning":[],"meaning-to-jp":[],"reading-to-jp":[]},a=document.getElementById(`question`),o=document.getElementById(`answer`),s=document.getElementById(`guessedCount`),c=document.getElementById(`guessedList`),l=document.getElementById(`remainCount`),u=document.getElementById(`historyToggleBtn`),d=document.getElementById(`historyPanel`);`serviceWorker`in navigator&&navigator.serviceWorker.register(`/flashcard-n3-vite/sw.js`);function f(){return r[n]}function p(){return i[n]}function m(){let e=f(),t=p();if(s.textContent=String(t.length),l.textContent=String(e.length),t.length===0){c.innerHTML=`<div class="empty">ยังไม่มีคำที่ทายแล้ว</div>`;return}c.innerHTML=t.map((e,t)=>`
    ...
    `;return}t=e[Math.floor(Math.random()*e.length)],o.innerHTML=``,n===`jp-to-meaning`?(a.className=`card jp-question`,a.textContent=t.kanji):n===`meaning-to-jp`?(a.className=`card meaning-question`,a.innerHTML=`
    <div class="meaning-question-content">
      <div class="th-question">${t.th}</div>
      <div class="en-question">${t.en}</div>
    </div>
  `):(a.className=`card reading-question`,a.textContent=t.reading)}async function g(){try{e=await(await fetch(`/flashcard-n3-vite/vocab.json`)).json(),r={"jp-to-meaning":[...e],"meaning-to-jp":[...e],"reading-to-jp":[...e]},i={"jp-to-meaning":[],"meaning-to-jp":[],"reading-to-jp":[]},h()}catch(e){console.error(`โหลด vocab.json ไม่ได้`,e)}}function _(){if(t){if(n===`jp-to-meaning`){o.innerHTML=`
    ...
    `;return}if(n===`reading-to-jp`){o.innerHTML=`
    <div class="answer-card">
      <div class="answer-section">
