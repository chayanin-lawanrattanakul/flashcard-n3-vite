(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[],t=null,n=document.getElementById(`question`),r=document.getElementById(`answer`);function i(){if(e.length===0){n.textContent=`🎉 Done!`,r.innerHTML=``;return}t=e[Math.floor(Math.random()*e.length)],n.textContent=t.kanji,r.innerHTML=``}async function a(){try{e=await(await fetch(`/flashcard-n3-vite/vocab.json`)).json(),i()}catch(e){console.error(`โหลด vocab.json ไม่ได้`,e)}}function o(){t&&(r.innerHTML=`
    <div class="box">
